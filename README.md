...
done < <(ls -1 /opt/ilm/infra/src/terraform/|grep -v bucket|sort|grep -v modules)
...
export STEP=121-bas-gcp-wpb-vm; ORG=ilm APP=opa ENV=dev TPL_SRC=/opt/ilm/ilm-opa-infra-app/ SRC=/opt/ilm/ilm-opa-infra-conf TGT=/opt/ilm/ilm-opa-infra-app/ make do-generate-conf-for-step
